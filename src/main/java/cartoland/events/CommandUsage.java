...
public class CommandUsage extends ListenerAdapter
{
	...
	public CommandUsage()
	{
		...
		commands.put(MEGUMIN, event ->
		{
			...
			event.reply("https://twitter.com/" + twitterAuthor.n() + "/status/" + Algorithm.randomElement(twitterAuthor.a())).queue();
		}); //隨機一張惠惠
...
/**
 * {@code TA} refers to TwitterAuthor, it stores the name of a Twitter author and his/her artworks ID. {@link #n} stands for
 * "name", and {@link #a} stands for "artworks".
 *
 * @since 1.3
 * @author Alex Cai
 */
record TA(String n, long... a) {}